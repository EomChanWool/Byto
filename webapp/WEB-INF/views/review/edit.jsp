<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <body>
            <form action="${pageContext.request.contextPath}/review/edit?review_num=${r.review_num}" method="POST"
                ...
                <table>
                    ...
                    <tr>
                        <td>내용</td>
                        <td>
                            <textarea name="review_content" id="review_content" cols="30" rows="10">

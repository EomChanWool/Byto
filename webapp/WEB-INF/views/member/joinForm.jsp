	...
	<section class="py-5">
		<div class="container px-4 px-lg-5 mt-5 container1 col-md-6">
			<div class="joincontainer">
				<img class="joinlogo" alt="로고" src="/img/carousel/logo1.png">
				<form action="/member/join" id="form" method="post">
					<!-- 아이디 -->
					<p class="joinlabel">아이디</p>
					<div class="mb-3">
						<input type="text" class="form-control" name="user_id"
							id="user_id" /> <span id="idResult"></span>
					</div>

					<!-- 비밀번호 -->
					<p class="joinlabel">비밀번호</p>
					<div class="mb-3">
						<input type="password" class="form-control" name="user_pwd"
							id="user_pwd" /> <span id="pwd1Result" class="message"></span>
					</div>
					<!-- 비밀번호 확인 -->
					<p class="joinlabel">비밀번호 확인</p>
					<div class="mb-3">
						<input type="password" class="form-control" id="pwdCheck" /> <span
							id="pwd2Result" class="message"></span>
					</div>
					<!-- 이름 -->
					<p class="joinlabel">이름</p>
					<div class="mb-3">
						<input type="text" class="form-control" name="user_name"
							id="user_name" /> <span id="nameResult" class="message"></span>
					</div>
					<p class="joinlabel">닉네임</p>
					<!-- 닉네임 -->
					<div class="mb-3">
					...
					<!-- 이메일 -->
					<p class="joinlabel">이메일</p>
					<div class="input-group mb-3">
						<input type="text" name="user_email1" id="user_email1"
							class="form-control" aria-label="이메일" /> <span
							class="input-group-text">@</span> <input type="text"
							id="user_email2" class="form-control" />
						<!-- 이메일선택 -->
						<button class="btn btn-outline-secondary dropdown-toggle"
							id="email_list" type="button" data-bs-toggle="dropdown"
							aria-expanded="false"></button>
						<ul class="dropdown-menu dropdown-menu-end">
							<li><a class="dropdown-item" onclick="changeEmail('')"
								value="">직접입력</a></li>
							<li><a class="dropdown-item"
								onclick="changeEmail('naver.com')" value="naver.com">네이버</a></li>
							<li><a class="dropdown-item"
								onclick="changeEmail('hanmail.net')" value="hanmail.com">다음</a></li>
							<li><a class="dropdown-item"
								onclick="changeEmail('google.com')" value="google.com">구글</a></li>
						</ul>
					</div>
					...
					<!-- 전화번호 -->
					<p class="joinlabel">전화번호</p>
					<div class="mb-3">
						<input type="text" class="form-control" name="user_tel"
							id="user_tel" /><br />
					</div>
					<!-- 우편번호 검색 -->
					<p class="joinlabel">주소</p>
					<script
						src="//t1.daumcdn.net/mapjsapi/bundle/postcode/prod/postcode.v2.js"></script>
					<script src="/static/js/postcode.js"></script>

					<div class="mb-3">
						<input type="text" class="form-control" placeholder="우편번호" name="user_postcode" id="user_postcode"
 							readonly></input>
					</div>
					<!-- 주소1 -->
					<div class="mb-3">
					...
					<button type="button" id="postcode" class="btn btn-secondary btn"
						onclick="sample6_execDaumPostcode()">주소찾기</button>
					<!-- 생일 -->
					<p class="joinlabel">생년월일</p>
					<div class="mb-3">
						<input id="user_birth" name="user_birth" type="date"
							min="1900-01-01" max="2000-01-01" class="form-control"
							value="1900-01-01" />
					</div>
					<!-- 타입 -->
					type<br /> <label><input type="radio" name="user_type"
						id="user_type" value="1" checked />일반회원</label> <label><input
						type="radio" name="user_type" id="user_type" value="2" />관리자</label><br />
					<!-- 가입버튼 -->
					<button type="submit" id="join" class="btn btn-primary btn"

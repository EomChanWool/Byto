                ...
                <section class="py-5">
                    <div class="container">
                            ...
                            <tr>
                                <td class="">
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <fmt:formatNumber var="val" value="${m.user_score/count}" pattern="#.##">
                                            </fmt:formatNumber>
                                            <c:set var="x" value="${val}"></c:set>
                                            <div class="progress" style="width: 336px; height: 25px">
                                                <div class="progress-bar bg-info" role="progressbar"
                                                    style="width: ${m.user_score/count*20}%">
                                                    <i class="fas fa-star"
                                                        style="font-size: 20px; color: #ffe607">${x}</i>
                                                </div>
                                            </div>
                                        </c:otherwise>
                                    </c:choose>
                        ...
                        <table>
                            <tr>
                                <td>
                                    <a style="width: 100px; height: 75px" href="/product/mylist"
                                        class="btn btn-outline-dark px-3 py-2 rounded-3"><i
                                            class="fs-1 fas fa-gifts w-100"></i>판매 내역</a>
                                </td>
                                <td>
                                    <a style="width: 100px; height: 75px" href="/wish/wishList"
                                        class="btn btn-outline-dark mx-3 px-3 py-2 rounded-3"><i
                                            class="fs-1 fas fa-shopping-bag w-100"></i>찜 목록</a>
                                </td>
                                <td>
                                    <a style="width: 100px; height: 75px" href="/product/add"
                                        class="btn btn-outline-dark px-3 py-2 rounded-3"><i
                                            class="fs-1 fas fa-plus-square w-100"></i>상품 등록</a>
                                </td>
                            </tr>
                        </table>

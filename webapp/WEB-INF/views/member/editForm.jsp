                ...
                <div class="container col-md-9">
                    ...
                    <form action="/member/edit" id="form" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="user_id" id="user_id" value="${m.user_id }"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control" name="user_pwd" id="user_pwd"
                                value="${m.user_pwd }" placeholder="비밀번호" />
                            <span id="pwd1Result" class="message"></span>
                        </div>
                        <!-- 비밀번호 확인 -->
                        <div class="mb-3">
                            <label for="pwdCheck" class="form-label">비밀번호 확인</label>
                            <input type="password" class="form-control" id="pwdCheck" value="${m.user_pwd }"
                                placeholder="비밀번호 확인" />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="user_name" id="user_name"
                                value="${m.user_name }" placeholder="이름" readonly />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="user_nickname" id="user_nickname"
                                value="${m.user_nickname }" placeholder="닉네임" />
                        </div>
                        <!-- 이메일 -->
                        <div class="input-group mb-3">
                            <label for="user_email1" id="email_label" class="form-label">이메일</label>
                            <input type="text" name="user_email1" id="user_email1" class="form-control"
                                placeholder="이메일" aria-label="이메일" />
                            <span class="input-group-text">@</span>
                            <input type="text" id="user_email2" class="form-control" />
                            <!-- 이메일선택 -->
                            <button class="btn btn-outline-secondary dropdown-toggle" id="email_list" type="button"
                                data-bs-toggle="dropdown" aria-expanded="false"></button>
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><a class="dropdown-item" onclick="changeEmail('')" value="">직접입력</a></li>
                                <li><a class="dropdown-item" onclick="changeEmail('naver.com')"
                                        value="naver.com">네이버</a></li>
                                <li><a class="dropdown-item" onclick="changeEmail('hanmail.net')"
                                        value="hanmail.com">다음</a></li>
                                <li><a class="dropdown-item" onclick="changeEmail('google.com')"
                                        value="google.com">구글</a></li>
                            </ul>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="user_tel" id="user_tel" value="${m.user_tel }"
                                placeholder="전화번호" />
                        </div>
                        <!-- 우편번호 검색 -->
                        ...
                        <div class="mb-3 postcode">
                            ...
                            <input type="text" name="user_postcode" id="user_postcode" style="width: 100px"
                                class="form-control" value="${m.user_postcode }" placeholder="우편번호" readonly />
                            <button type="button" id="postcode" class="btn btn-secondary btn"
                                onclick="sample6_execDaumPostcode()">주소찾기</button>
                        </div>
                        <!-- 주소1 -->
                        <div class="mb-3">
                            <input type="text" name="user_addr1" id="user_addr1" class="form-control"
                                value="${m.user_addr1 }" placeholder="주소" readonly />
                        </div>
                        <!-- 주소2 -->
                        <div class="mb-3">
                            <input type="text" name="user_addr2" id="user_addr2" class="form-control"
                                value="${m.user_addr2 }" placeholder="상세주소" />
                        </div>
                        <!-- 생일 -->
                        <div class="mb-3">
                            <label for="user_birth" class="form-label">생일</label>
                            <input id="user_birth" name="user_birth" type="text" class="form-control"
                                value="${m.user_birth }" readonly />
                    ...
                    <label><input type="radio" name="user_type" id="user_type" value="2" />관리자</label><br /> -->
                        ...
                        <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                            data-bs-target="#staticBackdrop">탈퇴하기</button>
                        <!-- =================================구분선=============================== -->
                        <!-- Modal -->

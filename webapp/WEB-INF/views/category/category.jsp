					...
					<div class="admin_all_category_area">
						...
						<div class="admin_category2">
							<table id="category2_print">
								...
								<tr>
									<td>
										<input type="text" id="category2_name" name="category_name" class="category2"
											placeholder="중분류 추가" />
									</td>
								</tr>
						...
						<div class="admin_category3">
							<table id="category3_print">
								...
								<tr>
									<td>
										<input type="text" id="category3_name" name="category_name" class="category3"
											placeholder="소분류 추가" />
									</td>
								</tr>
								...
								<tr>
									<td>
										<input type="button" id="add_category3_btn" class="add_category_btn"
											value="추가" />
									</td>
								</tr>
							</table>
						...
						<div class="admin_select_category_area">
							<table>
								...
								<tr>
									<td>
										<input type="text" name="select_category" class="select_category"
											id="selected_category" value="" />
									</td>
								</tr>

								<tr>
									<td>
										<input type="button" name="edit_btn" class="edit_btn" id="edit_btn"
											value="수정하기" />

                    ...
                    <form action="/report/add" method="post" id="report-form">
                        <div class="col-md-12">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control w-100" name="report_title" id="title"
                                    placeholder="제목" required />
                            </div>
                            <div class="mb-3">
                                <label for="content" class="form-label">신고사유</label>
                                <textarea class="form-control w-100" id="content" rows="12" name="report_content"
                                    placeholder="신고사유를 작성해주세요." required></textarea>
                            </div>
                            <div class="mb-3">

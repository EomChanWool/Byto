    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container px-4 px-lg-5">
                <!-- Logo -->
                <img src="/img/carousel/logo1.png" class="d-block w-30" height="100px" alt="...">
                <a class="navbar-brand" href="/">ByTO: 바이토</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                            <li>
                                                                <a class="dropdown-item"
                                                                    href="${pageContext.request.contextPath}/member/main">내
                                                                    정보</a>
                                                            </li>
                                                            <li>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button"
                                data-bs-toggle="dropdown" aria-expanded="false">제품목록</a>
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">

                                <li>
                                    <a class="dropdown-item"
                                        href="${pageContext.request.contextPath}/product/list">전체</a>
                                </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="${pageContext.request.contextPath}/qa/qa_board">Q/A</a>
                        </li>
                        <%-- 유저평점 <c:if test="${sessionScope.user_id != null}">
                            <li class="nav-item d-flex align-items-center px-2">
                                <i class="fas fa-star text-warning"></i>
                                <span>
                                    <c:import url="${pageContext.request.contextPath}/api/member/getScore"
                                        var="score" />
                            ...
                            --%> <%-- <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button"
                                    data-bs-toggle="dropdown" aria-expanded="false">카테고리로 찾기</a>
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <!-- value값은 카테고리 목록에서 받아오는 값으로 수정해야 함! 또한 c:forEach문 사용하여 목록 출력하도록 할 것 -->
                                    <li>
                                        <a class="dropdown-item"
                                            href="${pageContext.request.contextPath}/product/search?q=c1&value=0">의류</a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item"
                                            href="${pageContext.request.contextPath}/product/search?q=c1&value=0">가전제품</a>
                                    </li>
                    ...
                    <form class="d-flex" style="margin-bottom: 0px">
                        <button class="btn btn-outline-dark" type="button"
                            onclick="location.href='${pageContext.request.contextPath}/wish/wishList'">

            ...
            <section class="py-5">
                <div class="container">
                    ...
                    <form action="${pageContext.request.contextPath}/product/add" method="POST"
                        enctype="multipart/form-data" class="row g-3" id="product-form">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="number" class="form-control" id="product-price" min="0" max="20000000"
                                name="product_price" required />
                        </div>
                        <div class="col-md-12">
                            <label for="product-info" class="form-label">제품 정보</label>
                            <textarea class="form-control" id="product-info" rows="10" style="resize: none"
                                name="product_info" required></textarea>
                        </div>

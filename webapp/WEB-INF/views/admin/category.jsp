                        ...
                        <div class="c1 py-3 px-3 border">
                            ...
                            <div class="add-form w-100 my-3">
                                <form action="${pageContext.request.contextPath}/category/add" method="POST"
                                    itemref="c1-list" class="input-group">
                                    <input type="text" class="form-control w-75" placeholder="대분류 추가"
                                        aria-label="대분류 추가" aria-describedby="c1-btn" name="category_name" />
